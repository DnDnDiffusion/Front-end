      ...
      <div className="container flex flex-wrap items-center justify-between mx-auto">
        <a href="#home" className="flex items-center">
          <Image
            ...
            src={Logo}
            alt="logo"
            class="shrink w-20 object-contain"
          />
        </a>
        ...
        >
          <ul className="flex flex-col p-4 mt-4 border border-black-100 rounded-lg bg-black-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-black dark:bg-black-800 md:dark:bg-black-900 dark:border-black-700">
            <li>
              <a
                href="#"
                class="block py-2 pl-3 pr-4 text-white bg-red-700 rounded md:bg-transparent md:text-white-700 md:p-0 dark:text-white text-xl font-medium hover:text-yellow-500 transition-all"
                aria-current="page"
              >
                CREATE
              </a>
            ...
            <li>
              <a
                href="#"
                class="block py-2 pl-3 pr-4 text-white-700 rounded md:p-0 dark:text-white-400 text-xl font-medium hover:text-yellow-500 transition-all"
              >
                EXPLORE
              </a>
            </li>
