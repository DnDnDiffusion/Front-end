  ...
  return (
    <nav className="flex justify-start justify-between items-center p-6 container mx-auto">
      ...
      <ul className="sm:flex text-center hidden justify-between items-center p-9">
        <li className="text-yellow-500 mr-5 hover:text-red-500 hover:text-lg transition-all">
          <a href="#create">CREATE</a>
        </li>
        <li className="mx-5 hover:text-yellow-500 hover:text-lg transition-all">
        ...
        <li className="ml-5 hover:text-yellow-500 hover:text-lg transition-all">
