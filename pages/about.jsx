...
export default function About() {
  ...
  const getGPTData = async () => {
    const prefix = "Act as a novelist writing a story about a team of superheroes."
    const data = `We are a team building a project that lets you upload a character sheet and get back AI generated images so you can play with your friends more quickly.  Write us a secret internal culture story like this:  A Marvel style story formula about Narrow Arrow and the formation of the Productivity Pals, featuring Tippi, Danjo, Json, Somya and Aires, as well as their incredible supercar, named Grampa.  Use foreshadowing to imply the existence of an arch-nemesis working in the background named 'Scope Creeper' who is always trying to waste everybody's time.
